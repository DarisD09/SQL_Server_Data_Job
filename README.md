...
![Top Paying Jobs]("C:\Users\Daris Daniel\Downloads\SQL_Server_Data_Job\assests\top10_data_analyst_salaries.png")
*Bar graph visualizing the salary for the top 10 salaries
for data analysts; ChatGPT generated this graph from my
SQL query results*
...
![Top Paying Job Skills](assests\top10_skills_with_counts.png)
*Bar graph visualizing the count of skills for the top 10 paying jobs
for data analysts; ChatGPT generated this graph from my
SQL query results*
